...
import { CONSTS, getImgPath, IMAGE_SIZES, IMAGE_SIZES_PERCS } from '../reducers/constants'
        ...
        <>
            <div>
                    ...
                    <ThoughtBubble 
                        size={SIZES.MICRO} 
                        type={TYPES.ROUND}
                        bottom={.8 * headHeightPerc}
                        left={headWidthPerc}
                    />
                    <ThoughtBubble 
                        size={SIZES.MICRO} 
                        type={TYPES.ROUND}
                        bottom={.65 * headHeightPerc}
